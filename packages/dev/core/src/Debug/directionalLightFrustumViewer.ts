...
export class DirectionalLightFrustumViewer {
    ...
    protected _createGeometry() {
        ...
        this._trLinesPoints = [Vector3.ZeroReadOnly as Vector3, Vector3.ZeroReadOnly as Vector3];
        ...
        this._brLinesPoints = [Vector3.ZeroReadOnly as Vector3, Vector3.ZeroReadOnly as Vector3];
        ...
        this._tlLinesPoints = [Vector3.ZeroReadOnly as Vector3, Vector3.ZeroReadOnly as Vector3];
        ...
        this._blLinesPoints = [Vector3.ZeroReadOnly as Vector3, Vector3.ZeroReadOnly as Vector3];
